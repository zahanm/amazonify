...
%% users with a review count of 5 or higher. Though this subset does not reflect 
%% the real world, it allows us to gain insight on the significance of the 
...
%% Median reviews per user & 0
%% \tabularnewline \hline
%% Median reviews per product & 0
%% \tabularnewline \hline
...
%% \end{tabular}
%% \caption{ High activity Amazon statistics }
